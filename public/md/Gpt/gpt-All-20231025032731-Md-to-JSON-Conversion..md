...
- gpt  
- #gpt #code #keyword  
- 여기서는 `finalMarkdown`을 JSON 형식으로 유지하면서 파일을 저장하는 것으로 수정하고 싶으시군요.
...
###  <img src="https://raw.githubusercontent.com/d10000usd/WebDocuments/main/public/icon/space/workspace-vector-free-icon-set-38.png" width="50" height="50" /> context 3  
