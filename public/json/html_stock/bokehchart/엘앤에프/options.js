const getData_ohlc_texttype = async () => {
...
//     const resp = await res.json(); // 이전에 주석 처리한 부분을 다시 활성화하여 JSON 형식으로 데이터를 가져옵니다.
//     return resp; // 가져온 JSON 데이터를 반환합니다.
// };
...
const displayChart = async () => {
  ...
  const klinedata = await getData_ohlc_texttype();
