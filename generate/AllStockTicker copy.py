...
filtered_dict = {name: [market,code] for name, code, market in zip(filtered_df['Name'], filtered_df['Code'], filtered_df['Market'])}

# Write the dictionary to a JSON file


with open('/Users/hg/PROJECT/WebDocuments/public/DailyInfo/stock/csv/AllStockTicker.json', 'w', encoding='utf-8') as json_file:
